  ...
  const services = [
    {
      ...
      description:
        "Responsive designs tailored to your brand identity with modern UI/UX principles.",
      features: [
    ...
    },
    {
      ...
      description:
        "Complete online store with product management, cart, and secure payment integration.",
      features: [
    ...
    },
    {
      ...
      description:
        "Database-driven websites with content management systems for easy updates.",
      features: [
    ...
    },
    {
      ...
      description:
        "Fast-loading, cost-effective websites for small businesses and landing pages.",
      features: [
    ...
    },
    {
      ...
      description:
        "Showcase your work, projects, and skills with stunning portfolio layouts.",
      features: [
    ...
    },
    {
      ...
      description:
        "Ongoing support, security updates, hosting, and performance optimization.",
      features: [
        "Regular backups",
        "Security updates",
      ...
      types: [
        {
          title: "Static Website",
          description:
            "Pre-coded content that rarely changes. Loads fast and cost-effective.",
        ...
        },
        {
          title: "Dynamic Website",
          description:
            "Uses databases and server-side code for automatic content updates.",
      ...
      types: [
        {
          ...
          icon: <FaBriefcase />,
          description: "Company or service introduction",
        },
        {
          title: "E-commerce website",
          icon: <FaShoppingCart />,
        ...
        },
        {
          title: "Blog website",
          icon: <FaPen />,
          description: "Regular articles/posts",
        },
        {
          title: "Portfolio website",
          icon: <FaRegGem />,
        ...
        },
        {
          ...
          description: "Online courses, notes",
        },
        {
        ...
        },
        {
          ...
          icon: <FaComments />,
          description: "User discussions & Q&A",
        },
        {
  ...
  const process = [
    {
      ...
      title: "Consultation",
      description:
        "We listen to your needs - business, portfolio, or e-commerce?",
    },
    {
      step: "02",
  ...
  const testimonials = [
    {
      ...
      comment:
        "DigiPrime Lab built our company website. Got 50+ inquiries in first month! Great SEO work.",
      rating: 5,
    },
    {
      name: "Priya Singh",
      ...
      comment:
        "My e-commerce site is beautiful and payments work smoothly. Sales increased 200%!",
      rating: 5,
    },
    {
      name: "Amit Sharma",
      ...
      comment:
        "Portfolio website showcases my work perfectly. Clients love the design.",
      rating: 5,
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-purple-100 mb-8">
                Professional website development in Kolkata | 5+ years
                experience | 200+ websites delivered
              </p>
            ...
            <div className="hidden md:block">
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
                ...
                <p className="text-lg mb-4">
                  A website is a collection of HTML documents stored on a web
                  server and accessed via browsers using HTTP/HTTPS protocols.
                  It's a complete internet platform featuring static or dynamic
                  content.
                </p>
                <p className="text-purple-200">
                  In today's digital age, knowing how to build a website is
                  essential, or your business will lag behind.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Simply put, it's your online shop or digital business card. To
                grow your business, attract clients, and maintain a 24/7
                presence, a website is indispensable.
              </p>
              <div className="space-y-4">
                <div className="flex items-start">
                  <FaCheckCircle className="text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <p className="text-gray-700">
                    24/7 online presence – your business never sleeps
                  </p>
                </div>
                <div className="flex items-start">
                  <FaCheckCircle className="text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <p className="text-gray-700">
                    Connect directly with clients and showcase your work
                  </p>
                </div>
                <div className="flex items-start">
                  <FaCheckCircle className="text-green-500 mt-1 mr-3 flex-shrink-0" />
                  <p className="text-gray-700">
                    Generate leads and increase sales 24/7
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-purple-50 rounded-2xl p-8">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <p className="text-gray-700 italic mb-4">
                  "A business website helps small businesses connect directly
                  with clients. For digital agencies like DigiPrime Lab, it's
                  the best medium to showcase portfolios."
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose based on your needs – Knowing website types makes selection
              easier
            </p>
          </div>
              ...
              >
                ...
                <div className="bg-purple-50 rounded-lg p-4">
                  <p className="text-sm text-gray-700">
                    <span className="font-bold">Examples:</span> {type.examples}
                  </p>
                  <p className="text-sm text-gray-700 mt-2">
                    <span className="font-bold">Technology:</span> {type.tech}
                  </p>
                </div>
              </div>
            ))}
          ...
          <div className="text-center mt-8">
            <p className="text-lg text-gray-700">
              ...
              <span className="font-bold text-purple-600">
                website service in Kolkata or West Bengal?
              </span>{" "}
              DigiPrime Lab guides you step-by-step on how to build a website,
              plus offers maintenance.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              DigiPrime Lab's{" "}
              <span className="text-purple-600">Website Services</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              West Bengal's top website service provider with 5 years in digital
              content
            </p>
          </div>
            ...
            {services.map((service, index) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden relative ${
                  service.popular
                    ? "ring-2 ring-purple-500 transform scale-105 md:scale-100"
                    : ""
                }`}
              >
                {service.popular && (
                ...
                <div className="p-6">
                  ...
                  >
                    <div
                      className={
                        service.popular ? "text-white" : "text-purple-600"
                      }
                    >
                      {service.icon}
                    </div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">
              Free domain (.in) checks, mockups, and 7-day revisions. Static
              websites start at ₹5000, dynamic websites from ₹15000.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-purple-100">
              Your trusted website development partner in Kolkata
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyChooseUs.map((item, index) => (
              <div
                key={index}
                className="text-center bg-white/10 backdrop-blur-lg rounded-xl p-6 hover:bg-white/20 transition"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Simple 3 Steps to Your New Website
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <p className="text-lg text-gray-700">
              Don't learn how to build a website yourself –{" "}
              <span className="font-bold text-purple-600">
                order from DigiPrime Lab
              </span>{" "}
              to save time and get professional results!
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="px-8 py-12 md:p-12 text-center md:text-left md:flex md:items-center md:justify-between">
              <div className="mb-8 md:mb-0 md:mr-8">
                ...
                <p className="text-xl text-purple-100 max-w-2xl">
                  Professional website services in Kolkata – Free consultation &
                  quote
                </p>
              ...
              <div className="flex flex-col space-y-4 min-w-[250px]">
                <a
                  href="/contact"
                  className="bg-white text-purple-700 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition shadow-lg text-center"
                >
                  Free Consultation
                </a>
                ...
                <a
                  href="/contact"
                  className="border-2 border-white text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-purple-700 transition text-center"
                >
                  Get Free Quote
                </a>
              </div>
