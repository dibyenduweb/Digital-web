  ...
  const services = [
    {
      ...
      description:
        "Boost organic Google ranking with long-tail keywords like 'digital marketing agency in Kolkata' to drive quality traffic.",
      price: "₹5,000/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Grow engagement on Facebook, Instagram, YouTube with compelling content and influencer partnerships.",
      price: "₹7,000/month",
      features: [
        "Content Creation",
    ...
    },
    {
      ...
      description:
        "Targeted ads with 200% ROI guarantee. Instant leads via Google Ads and social media platforms.",
      price: "₹8,000/month",
      features: [
        "Keyword Targeting",
        "Ad Copy Writing",
    ...
    },
    {
      ...
      description:
        "Build trust with engaging blogs, video scripts, and website content that converts visitors to customers.",
      price: "₹4,000/month",
    ...
    },
    {
      ...
      description:
        "Customer retention through personalized email campaigns and newsletters that drive repeat business.",
      price: "₹3,000/month",
      features: [
        "Newsletter Design",
        "Automated Sequences",
    ...
    },
    {
      ...
      description:
        "Google Analytics tracking with monthly performance reports to measure ROI and optimize strategies.",
      price: "₹2,000/month",
      features: [
        "Traffic Analysis",
        "Conversion Tracking",
  ...
  const steps = [
    {
      ...
      title: "Free Audit",
      description:
        "We analyze your website, social media, and competitors to identify opportunities.",
    },
    {
      number: "02",
      title: "Strategy Plan",
      description:
        "Custom campaign creation tailored to your business goals and target audience.",
    },
    {
      number: "03",
      title: "Implement & Optimize",
      description:
        "Real-time results tracking with continuous optimization for maximum ROI.",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      comment:
        "DigiPrime Lab increased our leads by 500% in just 3 months. Best digital marketing agency in Kolkata!",
      rating: 5,
    },
    {
      name: "Priya Singh",
      ...
      comment:
        "Their SEO services got us to Google #1. Generated 200+ qualified leads in first month.",
      rating: 5,
    },
    {
      name: "Amit Kumar",
      ...
      comment:
        "Professional team, transparent reporting. Our sales doubled with their PPC campaigns.",
      rating: 5,
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="text-yellow-400">Grow Your Brand</span> with
                DigiPrime Lab
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <a
                  href="/contact"
                  className="bg-yellow-400 text-gray-900 px-8 py-4 rounded-lg font-bold text-lg hover:bg-yellow-300 transition flex items-center"
                >
                  Get Free Audit <FaArrowRight className="ml-2" />
                </a>

                <a
                  href="https://ranjitdigitalnest.netlify.app"
                  className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-blue-900 transition"
                >
                  View Portfolio
                </a>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Digital marketing is internet-based strategies using SEO, social
                media, PPC, content, and email to attract customers. It's
                cheaper and ROI-focused than traditional marketing. For
                small-large businesses in Kolkata or West Bengal, digital
                marketing services in Kolkata are essential.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                DigiPrime Lab, with 5 years of experience, gets your brand to
                Google #1 and generates leads.
              </p>
            </div>
            <div className="bg-blue-50 rounded-2xl p-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                – In 2026, 90% of customers search online before buying. It
                turns your brand local (Kolkata/Howrah) to global, boosts sales.
              </p>
              <div className="bg-white rounded-lg p-4 border-l-4 border-blue-600">
                <p className="text-gray-700 italic">
                  "A local shop gets 500+ leads/month with SEO services. We
                  deliver data-driven strategies with 300% ROI guarantee."
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose what you need – Digital marketing types vary by category
              and tools.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    Boosts organic Google ranking with long-tail keywords like
                    "digital marketing agency in Kolkata" to drive traffic.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-blue-600 mb-2">
                  ...
                  <p className="text-gray-600">
                    Grows engagement on Facebook, Instagram, YouTube.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-blue-600 mb-2">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Builds trust with blogs/videos.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-blue-600 mb-2">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-800 mb-6 pb-4 border-b">
                2. Common Types by Usage
              </h3>
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-blue-600 mb-2">Local SEO</h4>
                  <p className="text-gray-600">
                    Google My Business for Kolkata/West Bengal businesses.
                  </p>
                </div>
                <div>
                  <h4 className="font-bold text-blue-600 mb-2">
          ...
          <div className="text-center mt-8">
            <p className="text-lg text-gray-700">
              ...
              DigiPrime Lab guides how to get digital marketing services
              step-by-step.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              What You Get – West Bengal's top digital marketing company with 5
              years in digital content
            </p>
          </div>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">
              Free audit, 15-day trial, monthly reports. SEO services from
              ₹5,000/month, full package ₹25,000.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100">
              Your growth partner with proven results
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Simple 3 Steps to Digital Success
            </p>
          </div>
          ...
          <div className="text-center mt-12">
            <p className="text-lg text-gray-700">
              Don't wonder how to get digital marketing services –{" "}
              <span className="font-bold text-blue-600">
                contact DigiPrime Lab!
              </span>
            </p>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl overflow-hidden">
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 text-white">
                ...
                <p className="text-xl text-blue-100 mb-8">
                  DigiPrime Lab is your growth partner. Start your digital
                ...
                <button>
                  <a
                    href="/contact"
                    className="mt-8 inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 transition w-full md:w-auto text-center"
                  >
